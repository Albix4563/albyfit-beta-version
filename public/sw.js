...
const CACHE_NAME = 'albyfit-v0.9.5';
const CURRENT_VERSION = '0.9.5 [FINAL CANDIDATE RELEASE]';
const CHANGELOG_URL = '/CHANGELOG.md'; // Assicurati che il percorso sia corretto
const urlsToCache = [
  '/',
  '/static/js/bundle.js',
  '/static/css/main.css',
